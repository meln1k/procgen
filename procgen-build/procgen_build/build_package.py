...
def main():
    ...
    if platform.system() == "Linux":
        if "GITHUB_REF" in os.environ:
            ...
            os.environ["CIBW_ENVIRONMENT"] = os.environ["CIBW_ENVIRONMENT"] + " GITHUB_REF=" + os.environ["GITHUB_REF"]
        os.environ["CIBW_ENVIRONMENT"] = os.environ["CIBW_ENVIRONMENT"] + f" CACHE_DIR=/host{os.getcwd()}/cache"
    else:
